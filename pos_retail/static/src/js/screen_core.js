            ...
            if (order.order_in_kitchen) {
                ...
                if (manager_validate.length == 0) {
                    return self.pos.gui.show_popup('confirm', {
                        title: 'Warning',
                        body: 'Could not delete items while order in kitchen. If is required, need manager approve but your pos not set manager users approve on Security Tab',
                    })
                }
                return self.pos.gui.show_popup('selection', {
                    title: 'Choice Manager Validate',
                    body: 'Only Manager can Delete items after order in Kitchen, please ask him',
                    ...
                    confirm: function (manager_user) {
                        if (!manager_user.pos_security_pin) {
                            ...
                            return self.pos.gui.show_popup('ask_password', {
                                ...
                                body: _t('Your staff wants to delete items from order where order is in kitchen please approve'),
