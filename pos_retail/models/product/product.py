...
class product_template(models.Model):
    ...
    # English Extra Name for Removing Arabic
    english_name = fields.Char('English Name', index=True, required=True, translate=True)
...
class product_product(models.Model):
    ...
    english_name = fields.Char(string='English Name', related='product_tmpl_id.english_name',store=True)
