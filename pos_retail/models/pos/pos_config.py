...
class pos_config(models.Model):
    ...
    validate_global_discount = fields.Boolean('Validate Global Discount')
    ...
    pos_branch_address = fields.Char('Branch Adress')
    pos_branch_location = fields.Char('Branch Location')
