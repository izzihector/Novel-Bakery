...
class SaleReport(models.Model):
    ...
    product_cost = fields.Float('Cost Price', readonly=True)
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            l.product_id as product_id,
 	        (select cost from product_price_history where product_id = l.product_id order by cost desc limit 1) as product_cost,
